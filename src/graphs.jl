...
typealias DirectedIntGraph DirectedGraph{Int,Edge{Int},Range1{Int},Vector{Edge{Int}},Vector{Vector{Int}},Vector{Vector{Edge{Int}}}}
typealias UndirectedIntGraph UndirectedGraph{Int,Edge{Int},Range1{Int},Vector{Edge{Int}},Vector{Vector{Int}},Vector{Vector{Edge{Int}}}}
